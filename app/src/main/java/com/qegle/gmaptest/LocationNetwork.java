...
public class LocationNetwork implements ILocation {
	String PROVIDER;
	double lat ;
	double lon;
	...
	public LocationNetwork(Activity activity) {
		this.activity = activity;
		textViewNetwork = (TextView) this.activity.findViewById(R.id.textView_network);
	...
	private void showLocation(Location location) {
		...
		if (location.getProvider().equals(PROVIDER)) {
			textViewNetwork.setText(formatLocation(location));
		}
	}
